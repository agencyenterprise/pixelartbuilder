...
export function Header() {
  return (
    <header className="print:hidden relative flex items-center justify-between p-4 bg-[#BC0042]/80 text-white">
      <h1 className="flex items-center text-2xl absolute top-4 left-4">
      ...
      <a
        ...
        className="flex flex-col grow md:flex-row p-3 md:p-2.5 justify-center items-center gap-1 md:gap-4 text-sm font-normal md:h-11"
